<?php
header("Flag-Of-Babyfirst-2: CGCTF{HTTPheader##}");
setcookie("flag-of-babyfirst-3", "CGCTF{yummyCookie<3}");
?>
<!doctype html>
<!--
...
<html lang="en">
  <head>
    ...
    <title>CGCTF Web Challenge - Babyfirst</title>
    <meta name="flag-of-babyfirst-1" content="CGCTF{raw_HTTP_is_cool}">
